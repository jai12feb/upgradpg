...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, e.getMessage()); //else throw the exception.
        }
    }
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        // replace this line of code with your implementation
        try {
            User loggedInDoctor = userLoggedInService.getLoggedInUser();  // get currently logged in doctor
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            User loggedInDoctor = userLoggedInService.getLoggedInUser();   // get current loggedin doctor
            TestRequest testRequest = testRequestUpdateService.assignForConsultation(id,loggedInDoctor); // assign the test request(by id) to the given doctor for consultation
            return testRequest;
        }catch (AppException e) {
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            User loggedInDoctor = userLoggedInService.getLoggedInUser();    // get current loggedin doctor
            return testRequestUpdateService.updateConsultation(id, testResult, loggedInDoctor);  // update consultation details for testrequest(by id) for loggedIn doctor
