...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester() {
        ...
        try {
            User loggedInTester = userLoggedInService.getLoggedInUser();     //get the  current loggedin tester
            return testRequestQueryService.findByTester(loggedInTester);    //get all test requests assigned to the loggedin tester
